...
namespace LogosCorp\ExtendFieldLengthZipCode\Model\ResourceModel\Carrier\Tablerate\CSV;
...
class RowParser extends \Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\CSV\RowParser
{
    ...
    public function parse(
        ...
        $alias = $this->getAlias($rowData, $rowNumber, $columnResolver);
     ...
     * @throws RowException
     */
    private function getAlias(array $rowData, $rowNumber, ColumnResolver $columnResolver)
    {
        $aliasValue = $columnResolver->getColumnValue(\LogosCorp\ExtendFieldLengthZipCode\Model\ResourceModel\Carrier\Tablerate\CSV\ColumnResolver::COLUMN_ALIAS, $rowData);
        //$price = $this->_parseDecimalValue($aliasValue);
        $alias = trim($aliasValue);
